      ...
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start flex-col mf:mr-10">
          <h1 className="text-3xl sm:text-5xl text-white text-gradient py-1">
            Send Crypto <br /> Across The <br/> 
            World
          </h1>

          <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base">
            Explore the crypto world with the DLT Africa web-3 club
          </p>
          <button
            className="flex flex-row justify-center items-center my-5 bg-[#2852e3] p-3 rounded-full
          ...
          <div className="flex flex-col flex-1 items-start justify-start w-full mf:mt-0 mt-10">
              ...
              <div className="p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism">
                 ...
                 />
                     ...
                     <button className="text-white w-full mt-2 border-[1px] p-2 border[#3d4f7c] rounded-full cursor-pointer " type="button">
                        Send Now
                     </button>
              </div>
